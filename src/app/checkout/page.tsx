...
export default function Checkout() {
  ...
  useEffect(() => {
    async function createFinalOrder() {
      const isStripe = JSON.parse(localStorage.getItem('stripe') as any);
      ...
      if (
        ...
        const val: any = localStorage.getItem('checkoutFormData');
        const getCheckoutFormData = JSON.parse(val);
